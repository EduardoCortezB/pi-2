...
@section('content-page')
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <form action="{{route('language.update',$level->id)}}" class="g-3 needs-validation php-email-form" method="POST" novalidate>
            @csrf
            @method('PUT')
          <div class="row">
            <div class="col-md-6">
              <label for="validationCustom01">Idioma</label>
              <input type="text" name="language" value="{{$level->language}}" class="form-control @error('language') border-danger @enderror" id="validationCustom01" placeholder="Nombre" required>
              @error('language')
