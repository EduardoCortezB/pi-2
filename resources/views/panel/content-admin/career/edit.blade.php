...
@section('content-page')
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <form action="{{route('career.update', $career->id)}}" class="g-3 needs-validation php-email-form" method="POST" novalidate>
            @csrf
            @method('PUT')
          <div class="row">
            <div class="col-md-5">
              <label for="validationCustom01">Nombre de la carrera</label>
              <input type="text" name="career_name" value="{{$career->career_name}}" class="form-control @error('name') border-danger @enderror" id="validationCustom01" placeholder="Nombre" required>
              @error('career_name')
