  ...
  <section class="breadcrumbs">
    <div class="container">
      ...
      <ol>
        ...
        <li><a href="#">REGISTRO DE ASPIRANTE AL CELUT</a></li>
        <li>INFORMACIÓN ACERCA DEL ASPIRANTE</li>
      </ol>
      <h2>REGISTRO DE ASPIRANTE AL CELUT</h2>
    </div>
  </section><!-- End Breadcrumbs -->
<div class="container-fluid"> 

  <div class="row justify-content-center" style="margin:3rem !important">
    <div class="col-6 p-4">
