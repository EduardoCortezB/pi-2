...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto" style="font-size:25px"><a href="/">Centro de Lenguas de la UT<span></span></a></h1>
      ...
      <a href="/register-candidat" class="get-started-btn scrollto">Registrarse</a>
    </div>
  </header><!-- End Header -->
